            ...
            {isMobile ? (
              <div style={{width:"100%",background:"#111",borderRadius:14,border:"1px solid #1f1f1f",padding:"12px 14px"}}>
                ...
                <div style={{marginTop:10,height:3,background:"#1a1a1a",borderRadius:3,overflow:"hidden"}}>
                  <div style={{height:"100%",width:(oracle.price*100)+"%",background:"linear-gradient(90deg,"+B.green+","+B.green+"99)",transition:"width .5s"}}/>
                </div>
                <div style={{display:"flex",justifyContent:"space-between",marginTop:3}}>
                  <span style={{fontSize:9,color:B.green,fontWeight:700,fontFamily:fm}}>{(oracle.price*100).toFixed(0)}% {HOME.short}</span>
                  <span style={{fontSize:9,color:B.red,fontWeight:700,fontFamily:fm}}>{((1-oracle.price)*100).toFixed(0)}% {AWAY.short}</span>
                </div>
              </div>
            ) : (
