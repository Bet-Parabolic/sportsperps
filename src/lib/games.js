...
export const GAMES = [
  ...
  },
  {
    ...
    raw: [
      ...
      [34,.78,1,0,2,"51'","⚡ NED GOAL — Van Dijk header! (Gravenberch)",true],[37,.71,1,0,2,"55'","Japan respond instantly",false],
      [38,.42,1,1,2,"57'","⚡ JPN GOAL — Nakamura rifles low!",true],[41,.49,1,1,2,"61'","Open game in Dallas",false],
      [42,.50,1,1,2,"63'","Summerville cuts inside...",false],[43,.74,2,1,2,"64'","⚡ NED GOAL — Summerville off the post!",true],
      [48,.80,2,1,2,"72'","Oranje manage the lead",false],[52,.85,2,1,2,"78'","Japan pour forward",false],
      [56,.88,2,1,2,"85'","Dutch defending deep",false],[58,.86,2,1,2,"88'","Japan win a late corner...",false],
      [59,.07,2,2,2,"89'","⚡ JPN GOAL — Kamada deflection! 2-2!",true],
      [60,.03,2,2,2,"FT","FT — Kamada denies the Dutch, 2-2 draw",false],
    ],
  },
];
