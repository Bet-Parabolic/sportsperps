...
export const GAMES = [
  ...
  {
    id: "wc-ned-jpn", sport: "Soccer", label: "World Cup Group F",
    subtitle: "Jun 14, 2026 · Dallas", tagline: "Kamada's 89th-minute equaliser denies the Dutch in a 2-2 thriller",
    emoji: "⚽",
    ...
    raw: [
      [0,.56,0,0,1,"1'","Kick-off in Dallas — Oranje favoured",false],[4,.55,0,0,1,"12'","Depay tests Suzuki early",false],
      [9,.54,0,0,1,"27'","Japan stay compact",false],[14,.53,0,0,1,"42'","Cagey, goalless first half",false],
      [17,.53,0,0,1,"45'+2","Half-chance for Gakpo",false],[18,.53,0,0,0,"HT","HALFTIME — Netherlands 0-0 Japan",false],
      [22,.55,0,0,2,"48'","Dutch press after the restart",false],[33,.56,0,0,2,"50'","Gravenberch swings it in...",false],
      [34,.74,1,0,2,"51'","⚡ NED GOAL — Van Dijk header! (Gravenberch)",true],[37,.68,1,0,2,"55'","Japan respond instantly",false],
      [38,.52,1,1,2,"57'","⚡ JPN GOAL — Nakamura rifles low!",true],[41,.51,1,1,2,"61'","Open game in Dallas",false],
      [42,.52,1,1,2,"63'","Summerville cuts inside...",false],[43,.72,2,1,2,"64'","⚡ NED GOAL — Summerville off the post!",true],
      [48,.78,2,1,2,"72'","Oranje manage the lead",false],[52,.82,2,1,2,"78'","Japan pour forward",false],
      [56,.84,2,1,2,"85'","Dutch defending deep",false],[58,.82,2,1,2,"88'","Japan win a late corner...",false],
      [59,.50,2,2,2,"89'","⚡ JPN GOAL — Kamada deflection! 2-2!",true],
      [60,.50,2,2,2,"FT","FT — Kamada denies the Dutch, 2-2 draw (push)",false],
    ],
  },
];
...
export const BOX = {
  ...
  "wc-ned-jpn": {
    qtr:[{q:"1H",h:0,a:0},{q:"2H",h:2,a:2}],
    team:[["Possession","60%","40%"],["Shots on Target","5","3"],["Saves","1","3"]],
    pass:{h:[["V. van Dijk","51'","Header",""],["C. Summerville","64'","Left foot",""]],a:[["K. Nakamura","57'","Low drive",""],["D. Kamada","89'","Deflection",""]]},
    rush:{h:[],a:[]},rec:{h:[],a:[]},def:{h:[],a:[]},
